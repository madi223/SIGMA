...
UePrb::UePrb(uint8_t m_ulSymb)
 {
  this->m_ulSymb=m_ulSymb;
  m_dlSymb=0;
  m_allSymb=0;
  m_dlmcs=28;
  m_ulmcs=28;
...
uint8_t UePrb::GetUlSymb()
 {
  return m_ulSymb;
 }

uint8_t UePrb::GetDlSymb()
 {
  return m_dlSymb;
 }

uint8_t UePrb::GetAllSymb()
 {
  UePrb::ComputeAll(); 
  return m_allSymb;
 }

void UePrb::ComputeAll()
{
  m_allSymb = m_ulSymb + m_dlSymb;
}

void UePrb::SetUlSymb(uint8_t m_ulSymb)
{
  this->m_ulSymb = m_ulSymb;
}

void UePrb::SetDlSymb(uint8_t m_dlSymb)
{
  this->m_dlSymb = m_dlSymb;
}

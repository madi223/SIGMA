...
public:
  ...
  uint32_t               m_ranBdp           {0};
  uint32_t               m_ranBitRate       {0};
  uint32_t               m_ranTimer         {0};
  int                    m_ranNbRtts        {1};
  uint32_t               m_ranRttTimer      {0};
  uint32_t               m_prevCwnd         {0};
  bool                   m_isRanFull        {false};
...
protected:
  ...
  virtual void     SetRanBdp (uint32_t bdp);
  virtual uint32_t GetRanBdp (void) const;

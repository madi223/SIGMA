...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-Wall', '-march=native', '-fstrict-overflow', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-ffile-prefix-map=/build/python2.7-vgIf7a/python2.7-2.7.18=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-ffile-prefix-map=/build/python2.7-vgIf7a/python2.7-2.7.18=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-Wall', '-march=native', '-fstrict-overflow', '-std=c++11']
CXXFLAGS_GTK2 = ['-pthread']
CXXFLAGS_MACBUNDLE = ['-fPIC']
CXXFLAGS_PTHREAD = '-pthread'
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-ffile-prefix-map=/build/python2.7-vgIf7a/python2.7-2.7.18=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-ffile-prefix-map=/build/python2.7-vgIf7a/python2.7-2.7.18=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
ENABLE_GSL = None
ENABLE_GTK2 = '-pthread -I/usr/include/gtk-2.0 -I/usr/lib/x86_64-linux-gnu/gtk-2.0/include -I/usr/include/pango-1.0 -I/usr/include/atk-1.0 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/pango-1.0 -I/usr/include/libmount -I/usr/include/blkid -I/usr/include/fribidi -I/usr/include/cairo -I/usr/include/pixman-1 -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lharfbuzz -lfontconfig -lfreetype\n'
...
EXAMPLE_DIRECTORIES = ['udp-client-server', 'stats', 'naming', 'traffic-control', 'error-model', 'udp', 'matrix-topology', 'ipv6', 'socket', 'realtime', 'wireless', 'routing', 'tcp', 'energy', 'tutorial', 'bbr-tests']
...
NS3_EXECUTABLE_PATH = ['/home/madi/SIGMA/sigma/build/src/fd-net-device', '/home/madi/SIGMA/sigma/build/src/tap-bridge']
...
cfg_files = ['/home/madi/SIGMA/sigma/build/ns3/config-store-config.h', '/home/madi/SIGMA/sigma/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
